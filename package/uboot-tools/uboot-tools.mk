...
ifeq ($(BR2_PACKAGE_UBOOT_TOOLS_DEFAULT),y)
...
ifeq ($(BR2_PACKAGE_UBOOT_TOOLS_NOREDUNDENV),y)
define UBOOT_TOOLS_INSTALL_NOREDUNDENV
	$(INSTALL) -m 0755 -D $(@D)/tools/env/fw_printenv $(TARGET_DIR)/usr/sbin/fw_printenv
	ln -sf fw_printenv $(TARGET_DIR)/usr/sbin/fw_setenv
	cp -rf ./package/uboot-tools/fw_env_emmc.config $(TARGET_DIR)/etc/fw_env.config
endef
endif
ifeq ($(BR2_PACKAGE_UBOOT_TOOLS_HAVEREDUNDENV),y)
define UBOOT_TOOLS_INSTALL_HAVEREDUNDENV
	$(INSTALL) -m 0755 -D $(@D)/tools/env/fw_printenv $(TARGET_DIR)/usr/sbin/fw_printenv
	ln -sf fw_printenv $(TARGET_DIR)/usr/sbin/fw_setenv
	cp -rf ./package/uboot-tools/fw_env_emmc_redund.config $(TARGET_DIR)/etc/fw_env.config
endef
endif
ifeq ($(BR2_PACKAGE_UBOOT_TOOLS_UBINAND_NOREDUNDENV),y)
define UBOOT_TOOLS_INSTALL_UBINAND_NOREDUNDENV
	$(INSTALL) -m 0755 -D $(@D)/tools/env/fw_printenv $(TARGET_DIR)/usr/sbin/fw_printenv
	ln -sf fw_printenv $(TARGET_DIR)/usr/sbin/fw_setenv
	cp -rf ./package/uboot-tools/fw_env_nand.config $(TARGET_DIR)/etc/fw_env.config
endef
endif
ifeq ($(BR2_PACKAGE_UBOOT_TOOLS_UBINAND_HAVEREDUNDENV),y)
define UBOOT_TOOLS_INSTALL_UBINAND_HAVEREDUNDENV
	$(INSTALL) -m 0755 -D $(@D)/tools/env/fw_printenv $(TARGET_DIR)/usr/sbin/fw_printenv
	ln -sf fw_printenv $(TARGET_DIR)/usr/sbin/fw_setenv
	cp -rf ./package/uboot-tools/fw_env_nand_redund.config $(TARGET_DIR)/etc/fw_env.config
endef
endif
endif
...
define UBOOT_TOOLS_INSTALL_TARGET_CMDS
	...
	$(UBOOT_TOOLS_INSTALL_NOREDUNDENV)
	$(UBOOT_TOOLS_INSTALL_HAVEREDUNDENV)
	$(UBOOT_TOOLS_INSTALL_UBINAND_NOREDUNDENV)
	$(UBOOT_TOOLS_INSTALL_UBINAND_HAVEREDUNDENV)

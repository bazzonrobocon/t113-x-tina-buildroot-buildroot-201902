...
ifeq ($(BR2_PACKAGE_WPA_SUPPLICANT_NG),y)
...
WPA_SUPPLICANT_HASH_FILES += \
	$(sort $(wildcard \
		package/wpa_supplicant/$(WPA_SUPPLICANT_VERSION)/*.patch \
...
define WPA_SUPPLICANT_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 644 -D package/wpa_supplicant/$(WPA_SUPPLICANT_VERSION)/wpa_supplicant.conf \
